...
class RegistrationForm extends React.Component {
    ...
    validateField(fieldName, value) {
        ...
        switch(fieldName) {
            case 'time':
                ...
                timeValid = value.match(/^([\w.%+-]+)@([\w-]+\.)+([\w]{2,})$/i);
                fieldValidationErrors.time = timeValid 
                    ? <p className="isValid">Sweet! time is valid</p> 
                    : <p className="has-error">Please Enter a valid time</p>;
                break;
            default:
                break;
        }
    ...
    validateForm() {
        ...
        this.setState({formValid: this.state.timeValid});
    }
    ...
    onSubmitForm(e){
        ...
        if(this.state.formValid) {
            ...
            axios
                .post("/survey/addSurvey", userData)
                .then(res => {
